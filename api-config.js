...
const API_ENDPOINTS = {
    ...
    SLEEPOVER: {
        ...
        GET_ALL: `${API_BASE_URL}/sleepover-passes/admin`,
        ...
        GET_PENDING: `${API_BASE_URL}/sleepover-passes/admin/pending`,
        GET_ACTIVE: `${API_BASE_URL}/sleepover-passes/admin/active`
    },
